...
public class TicketDataModel {
    ...
    public TicketDataModel(String bestAsk, String bestAskSize, String bestBid, String bestBidSize, String price, String sequence, String size, long time) {
        this.bestAsk = bestAsk;
        this.bestAskSize = bestAskSize;
        this.bestBid = bestBid;
        this.bestBidSize = bestBidSize;
    ...
    public TicketDataModel(String bestAsk) {
        this.bestAsk = bestAsk;
    }
}
